...
namespace Moth
{
    public class CleanPolyAngleLessThanComponent : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the CleanPolyline class.
        /// </summary>
        public CleanPolyAngleLessThanComponent()
          : base("Clean Poly Angle Less", "CPoly L",
              "Reduces segments in a polyline where the angle between consecutive segments is less than the specified tolerance",
              "Moth", "Curve")
        {
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                var ImageBytes = Moth.Properties.Resources.CleanPolylineLess;
