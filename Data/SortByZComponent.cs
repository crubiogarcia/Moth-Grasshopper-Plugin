...
namespace Moth
{
    public class SortByZComponent : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the SortByY class.
        /// </summary>
        public SortByZComponent()
          : base("Sort by Z", "SortZ",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Parameter", "t", "Normalized Parameter", GH_ParamAccess.item);
        }
        ...
        {
            pManager.AddCurveParameter("Sorted", "S", "List of sorted curves by Z coordinate", GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                indexedC.Add(Tuple.Create(n, C[n], C[n].PointAtLength(t).Z));
            }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                var ImageBytes = Moth.Properties.Resources.SortZ;
        ...
        {
            get { return new Guid("4f50a475-7b8f-474a-a91d-d7409ba9aa61"); }
        }
    }
}