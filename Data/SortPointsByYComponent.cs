...
namespace Moth.Data
{
    public class SortPointsByYComponent : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public SortPointsByYComponent()
          : base("Sort Points By Y Coordinate", "SPY",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // Sort the indexedP list based on the Y coordinates of the Point3d
            indexedP.Sort((a, b) => a.Item2.X.CompareTo(b.Item2.Y));
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                var ImageBytes = Moth.Properties.Resources.SortPointsY;
        ...
        {
            get { return new Guid("E44F21BB-F034-45CD-9A6E-80575DEF4CB4"); }
        }
    }
}