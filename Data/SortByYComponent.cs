...
namespace Moth
{
    public class SortByYComponent : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the SortByY class.
        /// </summary>
        public SortByYComponent()
          : base("Sort by Y", "SortY",
        ...
        {
            pManager.AddCurveParameter("Sorted", "S", "List of sorted curves by Y coordinate", GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                indexedC.Add(Tuple.Create(n, C[n], C[n].PointAtLength(t).Y));
            }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                var ImageBytes = Moth.Properties.Resources.SortY;
        ...
        {
            get { return new Guid("AA46B496-77C9-45CD-8CF4-283AA8CB8804"); }
        }
    }
}